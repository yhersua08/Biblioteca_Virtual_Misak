...
DELIMITER 
CREATE PROCEDURE procInsertSolicitudCompra(
...
DELIMITER //
CREATE PROCEDURE procSelectSolicitudCompra()
BEGIN
...
DELIMITER //
CREATE PROCEDURE procUpdateSolicitudCompra(
    IN v_solic_id INT,
    IN v_solic_ticket VARCHAR(45),
    IN v_solic_fecha DATE,
    IN v_tbl_usuarios_usu_id INT
...
DELIMITER //
CREATE PROCEDURE procDeleteSolicitudCompra(IN v_solic_id INT)
BEGIN
